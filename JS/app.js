const cambiarBanner = function(evento){
    ...
    // Comprobar el valor del evento
    console.log(evento.srcElement.alt);
...
const banner = [
    ...
    fastAndFurious = {
        ...
        descripcion: "Dom y su equipo acabaron con el capo de la droga brasileño Hernan Reyes y diezmaron su imperio en un puente de Río de Janeiro. Su hijo Dante, que fue testigo de todo, lleva desde entonces ideando un plan maestro para hacer que Dom pague un precio muy alto por lo que hizo.",
    ...
    batman={
        ...
        descripcion: "Hace ya ocho años desde que Batman se convirtió en fugitivo al asumir la muerte de Harvey. La dura Ley Dent sigue aplacando la criminalidad de Gotham, aunque la llegada de una gata ladrona y un misterioso terrorista enmascarado lo cambiará todo.",
    ...
    tucker={
        ...
        descripcion: "Hilarante y desenfadada comedia de terror en la que dos grandes amigos,Tucker y Dale, de vacaciones en su destartalada casa de la montaña, son confundidos con paletos asesinos por un grupo de estudiantes detestables.",
    ...
    starWars={
        ...
        descripcion: "La Primera Orden, bajo el mando del líder supremo Snoke, está a punto de hacerse con el control militar de la galaxia. Sólo la general Leia Organa y sus combatientes de la Resistencia plantan cara a la creciente tiranía, convencidos de que el maestro jedi Luke Skywalker regresará y devolverá una chispa de esperanza a la lucha.",
    ...
    joker={
        titulo: "Joker",
        descripcion: "La pasión de Arthur Fleck, un hombre ignorado por la sociedad, es hacer reír a la gente. Sin embargo, una serie de trágicos sucesos harán que su visión del mundo se distorsione considerablemente convirtiéndolo en un brillante criminal.",
    ...
    harryPotter = {
        ...
        descripcion: "La batalla entre las fuerzas del bien y del mal del mundo mágico se convierte en una guerra que no deja a nadie indiferente. Harry Potter es quien tiene que hacer el último sacrificio antes de enfrentarse al malvado Voldemort.",
